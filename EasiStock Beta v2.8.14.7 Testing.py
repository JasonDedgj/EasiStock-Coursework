...
MainMenu.title("EasiStock v2.8.14.7")
Login.title("EasiStock - Please Log In")
settings.title("EasiStock v2.8.14.7 -  Settings")
edit_pg.title("EasiStock - Edit Product")
resetPass.title("EasiStock v2.8.14.7 -  Reset Password")
...
def Disclaimer(index, win):
        ...
        version = tk.Label ((index), text = "ES v2.8.14.7 BETA BUILD", font = ("Helvetica", 9))
        disclaimer = tk.Label ((index), text = "Content shown in the Beta Build may not work as expected.", font = ("Helvetica", 9, "italic"))
...
hold = input("EasiStock Private Beta Testing. \nPlease minimize this window. \n\nIf EasiStock is not showing up, please press enter here.")
